...
<body <?php body_class() ?> style="margin-top: 110px;" >
<div id="preloader">
    <div class="bubblingG">
...
<section class="menu-6">
    ...
    <nav class="navbar-dropdown blog-header">
        <div class="container">
                ...
                <div class="mbr-table-cell">
                    ...
                    <div class="navbar-brand">
                        <a href="<?php echo get_site_url() ?>" class="navbar-logo">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/images/logoPA.png" alt="Almendares">
                        </a>
                        <a class="navbar-caption" href="get_site_url"></a>
                    </div>

                </div>
                <div class="mbr-table-cell">
                    <button id="button-menu" class="navbar-toggler pull-xs-right hidden-md-up" type="button"  data-toggle="collapse" data-target="#exCollapsingNavbar">
                    ...
                    ?>
                    <button id="close-menu" hidden="" class="navbar-toggler navbar-close" type="button" data-toggle="collapse" data-target="#exCollapsingNavbar">
